...
This mean that everything including researching, coding, typing documentation and all the small seeminly insignificant steps will be done by me in order to learn and understand coding better.
    ...
    This project is meant to be a bit of a challenge to see how far I can go with traditional methods and to monitor my progress and compare it to my previous work experience that heavily utillize AI in order for me to coe and learn.
